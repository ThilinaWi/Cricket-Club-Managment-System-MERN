...
const Footer = () => {
  ...
  <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
    <div className="md:flex md:justify-between">
      <div className="mb-6 md:mb-0">
        <a href="https://flowbite.com/" className="flex items-center">
          <img className = "w-20 h-20"
            src="https://i.pinimg.com/originals/e2/63/e8/e263e8f739d6975cb42e30054b793a2d.png"
            //className="h-8 me-3"
            alt="FlowBite Logo"
          />
      ...
      <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          ...
          <ul className="text-gray-300 dark:text-gray-200 font-medium">
            <li className="mb-4">
    ...
    <hr className="my-6 border-gray-200 sm:mx-auto dark:border-bg-blue-50 lg:my-8" />
